Para subir una solucion deberas crear una carpeta con nick (nombre) , tomar el numero de reto que es en la lista de retos luego en tu soluciom deberas poner el nombre del ejercicio. 
